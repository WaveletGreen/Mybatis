...
public interface BaseDao<T> {
	 ...
	 *            需要持久化操作的实体类
	 * @return 
	 *         如果持久化操作成功，则返回<strong>"success"</strong>，反之返回<strong>"error"+持久化操作错误消息
	 *         </strong>，但是当传入的对象t为空时，则直接返回"error"
	 */
	 ...
	 *            需要删除的记录中的对象
	 * @return 
	 *         如果删除操作成功，则返回<strong>"success"</strong>，反之返回<strong>"error"+持久化操作错误消息
	 *         </strong>，但是当传入的对象t为空时，则直接返回"error"
	 */
	 ...
	 *            需要更新的记录中的对象
	 * @return 
	 *         如果更新操作成功，则返回<strong>"success"</strong>，反之返回<strong>"error"+持久化操作错误消息
	 *         </strong>，但是当传入的对象t为空时，则直接返回"error"
	 */
	 ...
	 * @param t
	 *            传入实体类的类名，与实体名一致
	 * @return 如果查找到，则返回所有的记录，没有则返回null
	 */
